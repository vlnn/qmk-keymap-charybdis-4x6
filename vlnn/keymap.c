...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_charybdis_4x6(
        ...
        MEH_T(KC_ESC), LALT_T(KC_A), LCTL_T(KC_S), LGUI_T(KC_D), LSFT_T(KC_F), KC_G, KC_H, RSFT_T(KC_J), RGUI_T(KC_K), RCTL_T(KC_L), RALT_T(KC_SCLN), KC_QUOT,
    ...
    [1] = LAYOUT_charybdis_4x6(
        ...
        MEH_T(KC_ESC), KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_NO,                    KC_PPLS, KC_P4, KC_P5, KC_P6, KC_PMNS, KC_PEQL,
